...
export const visitedPlacesData = [
  ...
  },
  {
    name: "Portland",
    state: "Oregon",
    coordinates: [45.5051, -122.675],
    visits: [
      { year: "2025", month: "October" },
      { year: "2025", month: "November" },
      { year: "2025", month: "December" },
    ],
    description: "City of Roses in the Pacific Northwest",
    categories: ["city"],
  },
  {
    name: "Bainbridge Island",
    state: "Washington",
    coordinates: [47.6477, -122.5194],
    visits: [{ year: "2025", month: "December" }],
    description: "Scenic island accessible by ferry from Seattle",
    categories: ["city"],
  },
  {
    name: "Mount Hood",
    state: "Oregon",
    coordinates: [45.3735, -121.696],
    visits: [{ year: "2025", month: "December" }],
    description: "Iconic stratovolcano and year-round skiing destination",
    categories: ["natural wonders"],
  },
  {
    name: "Lake Tahoe",
    ...
    visits: [{ year: "2025", month: "November" }],
    description: "Largest alpine lake in North America",
    categories: ["natural wonders"],
  },
  {
    name: "Big Sur",
    state: "California",
    coordinates: [36.2704, -121.8078],
    visits: [{ year: "2025", month: "November" }],
    description: "Dramatic coastline along the Pacific Coast Highway",
    categories: ["natural wonders"],
  },
  {
    name: "Monterey",
    ...
    visits: [{ year: "2025", month: "November" }],
    description: "Coastal city known for Monterey Bay Aquarium and Cannery Row",
    categories: ["city"],
  },
  {
    name: "Arlington",
    state: "Virginia",
    coordinates: [38.8814, -77.0997],
    visits: [{ year: "2025", month: "July" }],
    description: "County across the Potomac from Washington DC",
    categories: ["city"],
  },
  {
    ...
    visits: [{ year: "2025", month: "July" }],
    description: "Blue Ridge Mountains park with Skyline Drive",
    categories: ["national park"],
  },
  {
    name: "Snoqualmie Falls",
    state: "Washington",
    coordinates: [47.5421, -121.8371],
    visits: [{ year: "2026", month: "February" }],
    description: "Spectacular 268-foot waterfall near Seattle",
    categories: ["natural wonders"],
  },
  {
    name: "Snoqualmie Pass",
    state: "Washington",
    coordinates: [47.4248, -121.4145],
    visits: [{ year: "2026", month: "February" }],
    description: "Mountain pass through the Cascade Range with ski resort",
    categories: ["natural wonders"],
  },
]
